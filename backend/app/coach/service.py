        ...
        input=[
            {
                ...
                "content": (
                    ...
                    "verified evidence. Never expose internal enum values, "
                    "snake_case action identifiers, JSON field names, or raw "
                    "application labels such as call_for_help, start_iv_fluids, "
                    "or activate_transfusion. Translate every action into natural "
